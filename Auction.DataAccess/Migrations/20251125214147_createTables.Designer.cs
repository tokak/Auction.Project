...
namespace Auction.DataAccess.Migrations
{
    ...
    [Migration("20251125214147_createTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Auction.DataAccess.Domain.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Auction.DataAccess.Domain.Bid", b =>
                {
                    b.HasOne("Auction.DataAccess.Domain.ApplicationUser", "User")
                        .WithMany("Bids")
            ...
            modelBuilder.Entity("Auction.DataAccess.Domain.Vehicle", b =>
                {
                    b.HasOne("Auction.DataAccess.Domain.ApplicationUser", "Seller")
                        .WithMany("Vehicles")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Auction.DataAccess.Domain.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
